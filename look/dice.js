...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-028d0629');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-028d0629');}
...
function clearFlash(){dieView.classList.remove('rl-win-028d0629');dieView.classList.remove('rl-lose-028d0629');if(frameEl){frameEl.classList.remove('rl-win-028d0629');frameEl.classList.remove('rl-lose-028d0629');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-028d0629');if(frameEl){frameEl.classList.add('rl-win-028d0629');}}else{dieView.classList.add('rl-lose-028d0629');if(frameEl){frameEl.classList.add('rl-lose-028d0629');}}
...
var brandEl=document.querySelector('.rl-brand-028d0629');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
